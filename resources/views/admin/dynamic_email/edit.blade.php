          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
              ...
              <input type="hidden" name="id" value="{{$email->id}}"
                    <textarea id="description" value="{{$email->description}}" name="description" rows="10" cols="80">
                    {{$email->description}}
                    </textarea>
                     <div class="box-body">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="subject" value="{{$email->subject}}"  placeholder="Enter Mail Title">
                </div>
                </div>
