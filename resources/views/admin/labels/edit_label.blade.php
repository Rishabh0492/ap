      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="/update/labels">
                   {{ csrf_field() }}
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1"  name="labelName" value="{{$label->label_name}}" placeholder="Enter Label Name" require>
                </div>
                </div>
                 <div class="box-body">
               <div class="form-group">
                  <label for="value">Label Value</label>
                  <input type="text" class="form-control" id="labelValue"  name="labelValue" placeholder="Enter Label Value" value="{{$label->label_value}}">
                </div>   
              </div>
                 <div class="box-body">
              <!-- /.box-body -->
